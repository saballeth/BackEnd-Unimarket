...
Sección 6: Lógica de Notificaciones

Envía alertas a compradores y vendedores tras eventos del sistema.
Diseñado para ser reemplazado por push notifications (FCM) en producción.
"""
...
class NotificationService:
    ...
    En producción: integrar con FCM (Firebase) para push notifications Flutter.
    """
    ...
    def notify_payment_success(
        ...
        """Notifica éxito de pago al comprador y al emprendedor."""
        self.send(
